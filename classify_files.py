...
if __name__ == "__main__":
    ...
    _data_t_A,_data_t_B  = readFile(_testFile)
    ...
    _dA,_dB = normalize(_dataA+_data_t_A,_dataB+_data_t_B)

    _dataA = _dA[:_training,:]
    _data_t_A = _dA[_training:,:]

    _dataB = _dB[:_training,:]
    _data_t_B = _dB[_training:,:]
