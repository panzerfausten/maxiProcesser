...
=======
		...
		s = session("p2/eduardo_relax3/1435359906650/")
		plotGSR("p2/eduardo_relax3","eduardo_relax2_GSR",s,_limy=[0.0,10.0])
		plotTEMP("p2/eduardo_relax3","eduardo_relax2_TEMP",s,_limy=[30,40])
		plotHR_ZEPHYR("p2/eduardo_relax3","eduardo_relax3_HR",s,_limy=[0.0,120])
		plotIBI_ZEPHYR("p2/eduardo_relax3","eduardo_relax_3_IBI",s,_limy=[0.4,1])
		_data = s.groupBySec(s._dataGSR,True,False)
		htr = HalfRecoveryTimeDetector(_data)
		htr.plot("p2/eduardo_relax3/plots/eduardo_relax3_HTR")
		...
		plotIBI_ZEPHYR("p5/alma_rest","alma_rest_IBI",s,_limy=[0.4,1])
        	...
        	s = session("p5/alma_relax2/1435014511799/")
		plotGSR("p5/alma_relax2","alma_relax2_GSR",s,_limy=[0.0,10.0])
		plotTEMP("p5/alma_relax2","alma_relax2_TEMP",s,_limy=[30,40])
		plotHR_ZEPHYR("p5/alma_relax2","alma_relax2_HR",s,_limy=[0,120])
		plotIBI_ZEPHYR("p5/alma_relax2","alma_relax2_IBI",s,_limy=[0.4,1])
                _data = s.groupBySec(s._dataGSR,True,False)
                htr = HalfRecoveryTimeDetector(_data)
		...
		plotIBI_ZEPHYR("p6/luismiguel_relax2","luismiguel_relax2_IBI",s,_limy=[0.4,1])
                _data = s.groupBySec(s._dataGSR,True,False)
                htr = HalfRecoveryTimeDetector(_data)
		...
		plotGSR("p6/luis_relax3","luis_relax3_GSR",s,_limy=[0.0,20.0])
		plotTEMP("p6/luis_relax3","luis_relax3_TEMP",s,_limy=[30,40])
		plotHR_ZEPHYR("p6/luis_relax3","luis_relax3_HR",s,_limy=[0,120])
		plotIBI_ZEPHYR("p6/luis_relax3","luis_relax3_IBI",s,_limy=[0.4,1])
                _data = s.groupBySec(s._dataGSR,True,False)
                htr = HalfRecoveryTimeDetector(_data)
                htr.plot("p6/luis_relax3/plots/luis_relax3_HTR",_ylim=[0,15])
                print "p6 done"
                ######p7 and p8###################
		...
		plotIBI_ZEPHYR("p8/angello_relax2","angello_relax2_IBI",s,_limy=[0.4,1])
                _data = s.groupBySec(s._dataGSR,True,False)
                htr = HalfRecoveryTimeDetector(_data)
		...
		plotIBI_ZEPHYR("p8/angello_relax3","angello_relax3_IBI",s,_limy=[0.4,1])
                ...
                print "p8 done"
                """
>>>>>>> d358f009dd91eeb84a9a9b2b849310d16126875a
